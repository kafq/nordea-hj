...
export default class Database {
    static getAccessToken(callback) {
        fetch('https://api.hackathon.developer.nordeaopenbanking.com/v1/authentication/access_token', {
            method: 'get',
            headers: {
    ...
    static sendNewPayment(amount, message, name) {
        fetch(`https://api.hackathon.developer.nordeaopenbanking.com/v2/payments/sepa`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
        ...
        }).then((res) => {console.log(res); return res.json()}).then((json)=> {console.log(json)})
    }
}